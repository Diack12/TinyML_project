...
/* Includes ---------------------------------------------------------------- */
#include <Composants_Classification_inferencing.h>
...
void loop()
{
    ...
    // Print the prediction results (classification)
        ...
        // --- AJOUT: construire un JSON "propre" sur une seule ligne ---
        int winner_ix = -1;
        float winner_prob = -1.0f;
        ...
        //  on met un marqueur "EI:" pour filtrer facilement dans Node-RED
        ei_printf("EI:{\"winner\":\"%s\",\"prob\":%.5f",
                  ei_classifier_inferencing_categories[winner_ix],
                  winner_prob);
...
// to use the OV7675_::readFrame function.
//
int OV7675_::begin(int resolution, int format, int fps)
{
...
int OV7675_::allocate_scratch_buffs()
{
...
int OV7675_::deallocate_scratch_buffs()
{
...
//
void OV7675_::readFrame(void* buffer)
{
    allocate_scratch_buffs();
